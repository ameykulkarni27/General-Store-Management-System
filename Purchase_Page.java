...
public class Purchase_Page extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Purchase_Page frame = new Purchase_Page();
	...
	public Purchase_Page() {
		...
		updt.setBounds(1247, 656, 248, 50);
		updt.addActionListener(this);
		contentPane.add(updt);
		
		JLabel lblNewLabel_5 = new JLabel("");
		lblNewLabel_5.setIcon(new ImageIcon("istockphoto-876656396-612x612 (1).jpg"));
		lblNewLabel_5.setBounds(0, 0, 1536, 783);
					...
					if(rs.next())
					{
						...
						if(pn.equals(stk_nm))
						{
							...
							if(price==stk_price)
							{
								...
								stmt.executeUpdate("insert into purchase(Name,ID,Price,Quantity)values('"+pn+"',"+pid+","+price+","+qtty+")");
